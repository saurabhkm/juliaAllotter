...
function writePerformance(anAllotment, choiceGoodnessOld, cpiGoodnessOld, choiceGoodnessNew, cpiGoodnessNew, utility)
	save("juliaAllotter/myfile.jld", "allotment", allotment, "choiceGoodnessOld", choiceGoodnessOld, "cpiGoodnessOld", cpiGoodnessOld, "choiceGoodnessNew", choiceGoodnessNew, "cpiGoodnessNew", cpiGoodnessNew, "utility", utility)
end